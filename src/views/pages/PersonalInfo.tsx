  ...
  return (
    <>
      ...
      <div className="card p-6 pb-0 mb-6">
        ...
        <p className="text-gray-600 mb-4 text-sm">Những người khác sử dụng các dịch vụ của Google có thể nhìn thấy một số thông tin. </p>
        </div>
        <div className="space-y-4">
          <div className="flex justify-between items-center border-b pb-4 hover:bg-gray-50">
            ...
            <div className="flex items-center">
              ...
              <FiChevronRight className="text-2xl text-gray-400 ml-auto" />
            </div>
          </div>
          <div className="flex justify-between items-center border-b pb-4 hover:bg-gray-50">
